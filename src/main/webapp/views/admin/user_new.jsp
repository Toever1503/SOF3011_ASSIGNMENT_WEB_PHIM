...
<body>
	...
	<div class="body-content">
		...
		<div class="main-content">
			<span class="add-new-film"><a href="/SOF3011_ASSIGNMENT/admin/user">Quay Lại</a></span>
			<style>
.add-new-film {
	...
	background-color: white;
			...
			<div class="login">
				<form action="" onsubmit='return formValidate(this)' method="post">
					...
					<div>
						<label for="username">Tài khoản:</label> <input type="text"  value="${user.username }" pattern="[\w]+" title="Username only contains characters from a-z,0-9 and not have space"
					...
					<div>
						<label for="name">Họ Và Tên:</label> <input type="text" value="${user.fullname }"
					...
					<div>
						<label for="role">Role:</label> <input type="checkbox" ${user.admin == 1? 'checked': '' }
							name="admin" value="1" style="margin-left: unset;">
						Admin?
						<div class="hasError">
							<span></span>
						</div>
